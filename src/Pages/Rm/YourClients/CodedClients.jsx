...
const CodedClients = () => {
  ...
  useEffect(() => {
    dispatch(jrmCodedAllLeads(currentPage || 1, 5, searchQuery));
    ...
    const handleNext = () => {
      if (currentPage < totalPages) {
        ...
        dispatch(jrmCodedAllLeads(newPage, 5, searchQuery)); // Fetch leads for new page
      }
    };
  ...
  return (
    ...
    <p className="text-center text-2xl font-bold font-mono ">Coded List  <span className="text-btnColor">{totalJrmLeadsAllMyClients}</span></p>
      <div className="mb-4">
        <SearchInput
          value={searchQuery}
